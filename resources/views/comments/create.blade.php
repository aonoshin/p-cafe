...
<div class="comments-form">
    <form method="POST" action="{{route('comments.store', ['shop' => $shop->id])}}">
        ...
        <div class="comments-form-table">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input class="width-100" type="text" name="title" value="{{old('title')}}" autofocus>
                            @if($errors->has('title'))
                    ...
                    <tr>
                        <td>
                            <textarea class="width-100" name="content">{{old('content')}}</textarea>
        ...
        <ul class="comments-form-btn">
            <li><input type="submit" value="投稿する" onclick="return confirm('投稿してもよろしいですか？')"></li>
